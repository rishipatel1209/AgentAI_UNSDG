...
class LoadStreamlitUI:
    ...
    def load_streamlit_ui(self):
        ...
        with st.sidebar:
            ...
            if self.user_controls['selected_usecase']=='DeepRishSearch UNSDG Assistant':
            	self.user_controls["NewsAPI_KEY"] = st.session_state["NewsAPI_KEY"]=st.text_input("News API Key",type="password")
...
if __name__=='__main__':
    ...
    if user_message and user_input['UN SDG Country']and user_input['selected_usecase']=='Question Refining UNSDG Assistant':
    ...
    elif user_message and user_input['UN SDG Country'] and user_input['selected_usecase']=='DeepRishSearch UNSDG Assistant': 
        print("Deep Rishsearch")
        SmartQuestions=question_model(
                                loaded_tokenizer=loaded_tokenizer,
                                loaded_model=loaded_model, llm=llm, df_keys=df_keys,)
        builder=BuildGraphOptions(SmartQuestions, extended_research=True)
        graph=builder.build_graph()
        with st.chat_message("assistant"):
            intro="Hello, I am an assistant designed to help you learn about the 17 UN SDG goals listed here: https://sdgs.un.org/goals.\
						You can ask me about any of the goals or specific topics, and I will provide you with information and resources related to them.\
